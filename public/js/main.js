...
const pernalCodeCopyButton = document.getElementById('personal_code_copy_button');
pernalCodeCopyButton.addEventListener('click', () => {
...
micButton.addEventListener("click", () => {
    ...
    const micEnabled = localStream.getAudioTracks()[0].enabled;//assumed one stream
...
cameraButton.addEventListener("click", () => {
    const localStream = store.getState.localStream;
    const cameraEnabled = localStream.getVideoTracks()[0].enabled;//assumed one stream
