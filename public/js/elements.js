...
export const getIncomingCallDialog = (
    ...
    const accepptCallButton = document.createElement("button");
    accepptCallButton.classList.add("dialog_accept_call_button");
    ...
    accepptCallButton.append(acceptCallImg);
    buttonContainer.appendChild(accepptCallButton);
    ...
    accepptCallButton.addEventListener('click', () => {
        acceptCallHandler();//its parameter to above function
    });
    ...
    /*const dialogHTML = document.getElementById("dialog");//only show when needed
...
export const getLeftMessage = (message) => {
    ...
    const messagePragraph = document.createElement("p");
    messagePragraph.classList.add("message_left_paragraph");
    messagePragraph.innerHTML = message;
    messageContainer.appendChild(messagePragraph);
...
export const getRightMessage = (message) => {
    ...
    const messagePragraph = document.createElement("p");
    messagePragraph.classList.add("message_right_paragraph");
    messagePragraph.innerHTML = message;
    messageContainer.appendChild(messagePragraph);
